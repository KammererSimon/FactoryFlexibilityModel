...
def create_steel_plant(model_parameters, plant_type, config = None):
    ...
    if plant_type == "Partial":
        ...
        # deactivate CCS
        scenario.configurations[plant.get_key("CCS")] = {"power_max": 0}
    ...
    elif plant_type == "Hydrogen1200":
        print("simulating hydrogen layout with 1200MW electrolyzer")
