...
def add_unit(app, *args):
    ...
    app.app_select_unit(app.blueprint.units[unit_key])
...
def select_unit_list_item(app, list_item, touch):
    ...
    def select(*args):
        ...
        if list_item.text == "Add Unit":
            ...
            app.app_select_unit(app.blueprint.units[app.get_key(list_item.text)])

    def save_and_select(*args):
        app.save_changes_on_unit()
        select()
...
def update_unit_list(app):
    ...
    for unit in app.blueprint.units.values():
        ...
        item = TwoLineIconListItem(
            ...
            on_touch_down=app.app_select_unit_list_item,
        )
