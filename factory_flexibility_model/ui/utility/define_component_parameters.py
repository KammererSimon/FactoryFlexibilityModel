def define_component_parameters():
    ...
    component_parameter_list = {
        ...
        "deadtime": {
            "parameters": deadtime_parameters,
        ...
        "sink": {"parameters": sink_parameters, "default_icon": "sink_default"},
        "source": {"parameters": source_parameters, "default_icon": "source_default"},
        "storage": {
            "parameters": storage_parameters,
            "default_icon": "storage_default",
        },
        "thermalsystem": {
            "parameters": thermalsystem_parameters,
            "default_icon": "thermalsystem_default",
        },
        "triggerdemand": {
            "parameters": triggerdemand_parameters,
    ...
    with open(
        ...
        yaml.dump(component_parameter_list, file)
